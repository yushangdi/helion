"""B200 config for the tcgen05 register-fragment interleaved SwiGLU kernel."""
...
def key_interleaved_swiglu(*args) -> int:
    """Use the sole checked-in config; static shapes remain separately compiled."""
    return 0


def autotune_interleaved_swiglu(*args) -> dict:
    """Return the B200 config measured at M=1024, K=4096, packed D=11008."""
    return _CONFIG
